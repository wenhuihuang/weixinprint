...
<script type="text/javascript">
	...
	var canPrintTimes = '${canPrintTimes }';
	var isFreePrint = '${isFreePrint }';
</script>
...
<link rel="stylesheet" href="H5/yushang/assets/css/font-awesome.min.css">
  ...
  <style type="text/css">
  	.cropper-container img,.cropper-canvas{
  ...
  <div class="min-con">
    ...
    <div class="" id="photoTextRow">
    	<div class="">
    		...
    		<br>
    		<c:if test="${canPrintTimes <= 0 && isFreePrint != 1 }">
...
<!-- 	
  ...
  <script type="text/javascript" src="H5/yushang/compressImg/lrz.bundle.js"></script>
