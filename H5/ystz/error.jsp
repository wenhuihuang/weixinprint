...
<script type="text/javascript">
	...
	function goback(){
		if('${sessionScope.accesstype}'=="aloneqrcode"){
			<%-- mainUrl =  '<%=MessageUtil.DEFAULT_IP%>'+"wechatprinter/oauth/oauth.do?func=accessalone&did=${sessionScope.did}&pid=${sessionScope.pid}"; --%>
			closew();
		}else{
...
<body>
	<div class="wrap">
		<div class="tips-wrap">
			<p style="padding:0 8px;">${msg }</p>
			
		</div>
		<div class="input-wrap" style="font-size:16px;font-weight: bold;color:#fff;" onclick="goback()">
			<a href="javascript:;" class="sub-btn" id="retry" >返回</a>
		</div>
	</div>
	<div id="uploading" >
		<p>请稍后</p>
