...
<body>
    ...
    <div class="pic_edit">
        ...
        <div id="clipArea">
            <input type="file" class="photo-file" id="file">
        </div>
        <!-- 广告区域 -->
    ...
    <script>
        ...
        var scale = 210 / 296; //打印比例 -> 根据宽度可以计算出高度
        ...
        $(function () {
            ...
            $('.ad-img').css('width', body_width * 0.72);
            $('#photoTextRow').css('width', body_width * 0.72);
    ...
    <script>
        ...
        $(function () {
            ...
            $('.clear-img').css({
                "right": $clip_view.offset().left - 13 + 5
            }).click(function () {
                $('#file').val("").removeClass('active');
